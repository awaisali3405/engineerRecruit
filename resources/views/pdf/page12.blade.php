...
<body>
    {{-- <p>{{ $sub_contractor_date }}</p>
    <p>{{ $term_sub_contractor_name }}</p>
    <p>{{ $percentage }}</p>
    <p>{{ $contractor_name }}</p>
    <p>{{ $contract_date }}</p>
    <p>{{ $is_contact_confirm }}</p> --}}
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group mb-30 has-error has-danger">
                            <input type="Date" name="sub_contractor_date"
                                value="{{ old('sub_contractor_date', $sub_contractor_date) }}"
                                ...
                                value="{{ old('sub_contractor_date', $sub_contractor_date) }}" placeholder="Jhon Doe"
                                required="required">
                        </div>
                    </div>
                            ...
                            <div class="ml-40">
                                <div class="form-group mb-10 has-error has-danger">
                                    <input type="text" name="term_sub_contractor_name"
                                        value="{{ old('term_sub_contractor_name', $term_sub_contractor_name) }}"
            ...
            <div class="step flex mb-20">
                ...
                <div class="cont ml-40">
                    <p class="fz-13">The Sub-Contractor will receive,
                        <input type="text" name="percentage" value="{{ old('percentage', $percentage) }}"
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group mb-30 has-error has-danger">
                            <input type="text" name="contractor_name"
                                value="{{ old('contractor_name', $contractor_name) }}"
                    ...
                    <div class="col-12">
                        <div class="form-group flex">
                            <input type="checkbox" name="is_contact_confirm"
                                value="{{ old('is_contact_confirm', $is_contact_confirm) }}"
