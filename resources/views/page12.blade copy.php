    ...
    <div class="container">
        <div class="row justify-content-center">
                            ...
                            <div class="controls row">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-group mb-30 has-error has-danger">
                                        <input type="Date" name="sub_contractor_date" value="{{ old('sub_contractor_date') }}" onkeyup="document.getElementById('sub_contractor_date').value=this.value" onchange="document.getElementById('sub_contractor_date').value=this.value" value="{{ old('sub_contractor_date') }}" placeholder="Jhon Doe" required="required">
                                    </div>
                                </div>
                                    ...
                                    <div class="step flex mb-20">
                                        ...
                                        <div class="ml-40">
                                            <div class="form-group mb-10 has-error has-danger">
                                                <input type="text" name="term_sub_contractor_name" value="{{ old('term_sub_contractor_name') }}" onkeyup="document.getElementById('term_sub_contractor_name').value=this.value" onchange="document.getElementById('term_sub_contractor_name').value=this.value" placeholder="Jhon Doe" required="required">
                                            </div>
                        ...
                        <div class="step flex mb-20">
                            ...
                            <div class="cont ml-40">
                                <p class="fz-13">The Sub-Contractor will receive,
                                    <input type="text" name="percentage" value="{{ old('percentage') }}" onkeyup="document.getElementById('percentage').value=this.value" onchange="document.getElementById('percentage').value=this.value" eholder="" required="required"> %
                        ...
                        <form id="contact-form" method="post" action="#" novalidate="true">
                            ...
                            <div class="controls row">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-group mb-30 has-error has-danger">
                                        <input type="text" name="contractor_name" value="{{ old('contractor_name') }}" onkeyup="document.getElementById('contractor_name').value=this.value" onchange="document.getElementById('contractor_name').value=this.value" placeholder="Jhon Doe" required="required">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="mb-10">
                                    ...
                                    <div class="form-group mb-30 has-error has-danger">
                                        <input type="Date" name="contractor_date" value="{{ old('contractor_date') }}" onkeyup="document.getElementById('contractor_date').value=this.value" onchange="document.getElementById('contractor_date').value=this.value" placeholder="Jhon Doe" required="required">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group flex">
                                        <input type="checkbox" name="is_contact_confirm" value="{{ old('is_contact_confirm') }}" onkeyup="document.getElementById('is_contact_confirm').value=this.value" onchange="document.getElementById('is_contact_confirm').value=this.value" onclick="document.getElementById('is_contact_confirm').value=this.value" class="checkboxterms checkboxterms1" value="1"><span class="check-confirm ml-30">I herby confirm that I
            ...
            <form action="{{ route('page13.submit') }}" id="hidden-form" method="post" class="d-none">
                @csrf
                <input type="hidden" name="sub_contractor_date" id="sub_contractor_date" value="{{ old('sub_contractor_date') }}">
                <input type="hidden" name="term_sub_contractor_name" id="term_sub_contractor_name" value="{{ old('term_sub_contractor_name') }}">
                <input type="hidden" name="percentage" id="percentage" value="{{ old('percentage') }}">
                <input type="hidden" name="contractor_name" id="contractor_name" value="{{ old('contractor_name') }}">
                <input type="hidden" name="contract_date" id="contractor_date" value="{{ old('contractor_date') }}">
                <input type="hidden" name="is_contact_confirm" id="is_contact_confirm" value="{{ old('is_contact_confirm') }}">
            </form>
            <div class="col-12 text-center mt-70 d-flex justify-content-center">
                ...
                <button onclick="document.getElementById('hidden-form').submit()" style="border:white;" class="butn butn-md form-button-color text-light radius-10 ml-20 ml-xs-0">
